package retoBackendOrenes.RetoBackend.emailNotifications;
...
public class Email {
    ...
    private final String sender = "minijuegostec22@gmail.com";
    private final String pwd = "ofldotisgrqukwjr";
    ...
    public void send(String destinatario, String subject, String body) {
        ...
        properties.put("mail.smtp.user", "minijuegostec22@gmail.com");
        properties.put("mail.smtp.auth", "true");
        properties.put("mail.smtp.socketFactory.port", pwd);
