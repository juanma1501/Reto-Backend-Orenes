...
@Component
public class GetOrderTrackingByTrackingNumber {

    @Autowired
    TrackingRepository trackingRepository;

    public ResponseWrapper<List<OrderTracking>> getOrderTrackingByTrackingNumber (String trackingNumber){

        ResponseWrapper<List<OrderTracking>> wrapper = new ResponseWrapper<>();

        List<OrderTracking> orderTrackingList = trackingRepository.findByTrackingNumber(trackingNumber);
